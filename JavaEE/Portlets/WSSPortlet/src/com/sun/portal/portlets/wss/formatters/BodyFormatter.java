...
/**
 * Created by IntelliJ IDEA. User: root Date: Sep 11, 2006 Time: 7:06:02 AM To
 * change this template use File | Settings | File Templates.
 */
public class BodyFormatter {

    public List getFormattedNames(RenderRequest portletRequest, RenderResponse portletResponse, List list, String bodyView) {
	return null;
    }
