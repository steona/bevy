...
/**
 * Created by IntelliJ IDEA. User: root Date: Jan 20, 2007 Time: 9:23:05 AM To
 * change this template use File | Settings | File Templates.
 */
public class CalculatedFormatter implements InterfaceFormatter {
	...
	String actualValue = fieldValue.substring(i + 1);
	try {
	    Float f = new Float(actualValue.trim());
	    Integer ij = f.intValue();
	    return ij.toString();
