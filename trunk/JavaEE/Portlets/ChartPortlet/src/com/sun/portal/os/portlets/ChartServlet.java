...
public class ChartServlet extends HttpServlet {
    ...
    private Connection getDatabaseConnection(HttpServletRequest request) throws SQLException, NoPreferredDbSetException {
	...
	try {
		...
		JDBCCategoryDataset data = (JDBCCategoryDataset) generateBarChartDataSet(getDatabaseConnection(request), sql);
		chart = ChartFactory.createBarChart3D("Bar Chart", "Category", "Value", data, PlotOrientation.VERTICAL, true, true, false);
		...
		chart = ChartFactory.createTimeSeriesChart("Time Series Chart", "Date", "Rate", data, true, true, false);
	    }
