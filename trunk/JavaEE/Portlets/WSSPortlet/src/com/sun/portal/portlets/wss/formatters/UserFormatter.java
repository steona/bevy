...
/**
 * Created by IntelliJ IDEA. User: root Date: Aug 30, 2006 Time: 2:54:15 PM To
 * change this template use File | Settings | File Templates.
 */
public class UserFormatter implements InterfaceFormatter {

    public String getFormattedValue(String listName, String fieldValue, String id) {
	return (fieldValue.substring(3));

    }

    public String getFormattedValue(String listSoapAddress, String listName, String fieldValue, String id) {
	return getFormattedValue(listName, fieldValue, id);
    }
