...
/**
 * Created by IntelliJ IDEA. User: root Date: Sep 1, 2006 Time: 12:35:54 PM To
 * change this template use File | Settings | File Templates.
 */
public class LookupFormatter implements InterfaceFormatter {
	...
	String modstr = fieldValue.substring(i + 1);
	return df.getFormattedValue(modstr);
    }
