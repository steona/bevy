...
/**
 * Created by IntelliJ IDEA. User: root Date: Aug 30, 2006 Time: 3:28:18 PM To
 * change this template use File | Settings | File Templates.
 */
public class AttachmentsFormatter implements InterfaceFormatter {

    public String getFormattedValue(String listSoapAddress, String listName, String fieldValue, String id) {
	int i = Integer.valueOf(fieldValue).intValue();
	int j = Math.abs(i);
	String modstr = Integer.toString(j);
	return modstr;
    }
