...
<portlet:actionURL var="portletEditDisplayedList" portletMode="edit">
    <portlet:param name="edit" value="list"/>
</portlet:actionURL>


<a href="<%=portletEditSiteUrl.toString()%>">Edit Site</a><br/>
<a href="<%=portletEditDisplayedList.toString()%>">Edit List</a><br/>
